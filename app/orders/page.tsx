...
export default function Orders(){
 ...
 async function load(){
  ...
  if(track.length)Promise.allSettled(track.map(o=>fetch('/api/orders/tracking',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({orderId:o.id})})));
 }
 useEffect(()=>{load()},[]);

...
export const metadata:Metadata={title:{default:'LAPKA — товари для собак і котів',template:'%s | LAPKA'},description:'Корми, переноски, лежаки, одяг та аксесуари для собак і котів.'};

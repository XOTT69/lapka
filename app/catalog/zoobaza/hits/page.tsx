...
export default async function PopularPage(){
 ...
 return <main className="wrap page">
  <div className="pageIntro"><span className="eyebrow">Популярне</span><h1>Ходові позиції для старту</h1><p>Добірка товарів, які варто показувати першими: переноски, лежаки та товари для перевезення.</p></div>
  {error?<div className="empty">{error}</div>:products.length?
   ...
   <div className="empty"><h2>Добірка оновлюється</h2><p><Link href="/catalog">Перейти до каталогу</Link></p></div>}
 </main>
}

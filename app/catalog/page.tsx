...
export default async function CatalogPage({searchParams}:{searchParams:Promise<{q?:string}>}){
 ...
 try{items=await getZooBazaProducts(800)}catch(e){error=e instanceof Error?e.message:'Каталог тимчасово недоступний'}
 return <main className="wrap page">
  <div className="pageIntro"><span className="eyebrow">Каталог LAPKA</span><h1>Знайди потрібне швидко</h1><p>Живі товари ZooBaza з актуальними фото, цінами та наявністю.</p></div>

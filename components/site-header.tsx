...
export default function SiteHeader(){
 ...
 return <header className="siteHeader"><div className="wrap nav">
  ...
  <nav className="desktopNav"><Link className={path==='/catalog'?'active':''} href="/catalog">Каталог</Link><Link href="/catalog?pet=Собаки">Собаки</Link><Link href="/catalog?pet=Коти">Коти</Link><Link href="/pets">Профіль</Link></nav>
